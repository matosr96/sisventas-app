...
export const ErrorMessages: Record<string, string> = {
  ...
  "626": "El efectivo recibido no cubre el total.",
  "627": "El descuento no puede superar el subtotal.",
  "628": "La venta tiene devoluciones y ya no se puede anular.",
  "629": "No puedes devolver más unidades de las vendidas.",
